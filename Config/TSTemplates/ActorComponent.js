...
exports.generated@66010 = void 0;
var UE = require("ue");
var _MixinImportPath_1 = require("{MixinImportPath}");
// 蓝图类路径（Puerts绑定路径）
...
var default_1 = function () {
    var _classDecorators = [(0, _MixinImportPath_1.default)(AssetPath)];
...
}
{
    ...
    void {
        console: console,
        : .log("[Mixin] {BPName} ReceiveBeginPlay")
    };
    // 组件生命周期：每帧更新
    ...
    void {
        console: console,
        : .log("[Mixin] {BPName} ReceiveEndPlay")
    };
}
